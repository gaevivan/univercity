...
eng = ' abcdefghijlmnopqrstuvwxyz' #alphabet
...
if __name__ == '__main__':
    PCMoscow = Contact('moscow is the best city all of the world', 13)
    PCTver = Contact('tver better than moscow', 4)
    PCTula = Contact('tula better than moscow', 7)
    PCMoscow.getkey(PCTver)
    PCMoscow.send(PCTver)
    print PCTver.text
    PCMoscow.getkeyRSA(PCTula)
    PCMoscow.sendRSA(PCTula)
    print PCTula.text
